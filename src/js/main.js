...
function submit() {
  const formUrl =
    "https://script.google.com/macros/s/AKfycbw-ETNoLzdoQlO2Cyz_3dNbciw0q5GQNpRoImVubAvYaH0aQYn4CtQLfg/exec";
  const data = new FormData();
  data.append("name", "le van y");
  data.append("phone", "03455555");
  fetch(formUrl, {
    method: "POST",
    body: data,
  });
